...

{
    ...
    "currency": "EUR",
    'category': 'Accounting',
    "website" : "https://www.browseinfo.com/demo-request?app=bi_manual_currency_exchange_rate&version=19&edition=Community",
    "data" :[
        ...
        "views/sale_view.xml",
        "views/inherited_hr_expense_post_wizard.xml",
    ],
    "auto_install": False,
    "installable": True,
    'live_test_url':'https://www.browseinfo.com/demo-request?app=bi_manual_currency_exchange_rate&version=19&edition=Community',
