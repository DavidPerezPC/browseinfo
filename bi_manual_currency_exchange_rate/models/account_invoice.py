...
class InheritProductProduct(models.Model):
    ...
    def _prepare_out_svl_vals(self, quantity, company, lot=False):
        ...
        if active_model == 'sale.order':
            find_active = self.env.context.get('active_id')
...
class account_invoice_line(models.Model):
    ...
    def get_rate_hr_expense(self,price):
    ...
    def _compute_price_unit(self):
        for line in self:
            ...
            if line.move_id.expense_ids:
                ...
                line.price_unit =line.get_rate_hr_expense(line.move_id.expense_ids.total_amount_currency)
...
class account_invoice(models.Model):
    ...
    is_created_from_expense= fields.Boolean('Created from expense')
...
class ProductProduct(models.Model):
    ...
    def _get_tax_included_unit_price(self, company, currency, document_date, document_type,
        ...
        manual_currency_rate_active = self.env.context.get('manual_currency_rate_active')
